...
# This is a driver routine that calls NH_JRING_CREATE_OBJECTLIST() many times.
...
from  nh_jring_create_objectlist import nh_jring_create_objectlist
...
#==============================================================================
# NH_JRING_CREATE_OBJECTLISTS . This is the driver routine that calls the individual function many times.
#==============================================================================
...
# so we tag it and copy anyhow.
    ...
    # Do the call to find all objects (stars, satellites, etc)
            ...
            objects = nh_jring_create_objectlist(file, bodies = sats)
