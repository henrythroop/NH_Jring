...
#    bins_radius_out = bins_radius[bin_0:bin_1] # The bins that are used for the radial profile
...
#    bins_azimuth_out  = bins_azimuth[bin_0:bin_1]  # The bins that are used for the az profile
